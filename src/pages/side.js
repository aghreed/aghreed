...
const Side = () => (
  <Layout>
    ...
    {/* Yonder.Guide */}
    <section
      style={{ padding: `4rem 0`, background: `${offWhite}`, color: `${navy}` }}
    >
      <div css={goofySectionContainerStyle}>
        ...
        <div css={rightSideTextStyle}>
          ...
          <p>
            ...
            it’s not ready to help document travels around the world yet, a soft
            launch is coming this summer. For me, Yonder.Guide has been an
            opportunity to work with new tech like Apollo Client & Server,
    ...
    {/* Whitney's site */}
    <section
      style={{ padding: `5rem 0`, background: `${navy}`, color: `${offWhite}` }}
    >
      <div css={sectionContainerStyle}>
        <div css={leftSideTextStyle}>
          ...
          <p>
            I love any opportunity to work with talented designers like Whitney,
            and this project served as a great introduction to some new
            technologies for me. This was my first time working with designs
            made with Sketch, and was my first Gatsby site. I've since come to
            appreciate both technologies enough to use them in producing my own
            portfolio.
          </p>
        </div>
        <div css={rightSideImageStyle}>
          <div
            onClick={() =>
              window.open("http://www.whitneyjenich.com", "_blank")
            }
            style={{
              cursor: `pointer`,
              width: `100%`,
    ...
    {/* TBG site */}
    <section
      style={{ padding: `5rem 0`, background: `${offWhite}`, color: `${navy}` }}
    >
      <div css={goofySectionContainerStyle}>
        <div css={leftSideImageStyle}>
          <div
            onClick={() => window.open("http://www.tbgco.com", "_blank")}
            style={{
              cursor: `pointer`,
              width: `100%`,
              height: `100%`,
        ...
        <div css={rightSideTextStyle}>
          ...
          <p>
            In 2016, I collaborated with designer/photographer{" "}
            <a
            ...
            to create a custom-themed WordPress site for the company. We worked
            closely with the marketing team at TBG to overhaul their website by
            providing photography, design, copy, and an updated website that
            they could access and edit themselves through an easy-to-use CMS.
          </p>
        </div>
      </div>
    </section>
    ...
    <section
      style={{ padding: `5rem 0`, background: `${darkLime}`, color: `${navy}` }}
    >
      <div css={sectionContainerStyle}>
        <div css={leftSideTextStyle}>
          <h2>Talks</h2>
        ...
        <div css={rightSideImageStyle}>
          <div
            onClick={() =>
              window.open("https://youtu.be/QOiqPLL2Tec", "_blank")
            }
            style={{
              cursor: `pointer`,
              width: `100%`,
